...
<head>
  ...
  <title>HER WEBPRO2023</title>
  <link rel="icon" href="<?= base_url() ?>assets/dist/img/avatar.png">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 20 Hours Ago</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <span class="dropdown-item dropdown-header">100 Notifications</span>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> 14 new messages
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= base_url() ?>assets/index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">PT. JAYA ABADI</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">RESTIANA WINDA</a>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?=site_url('buku')?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?=site_url('pinjaman')?>" class="nav-link">
